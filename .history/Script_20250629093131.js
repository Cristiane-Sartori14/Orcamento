document.addEventListener("DOMContentLoaded", () => {
      ...
      document.getElementById("numeroOrcamento").textContent = new Date().getFullYear() + "." + Math.floor(100000 + Math.random() * 900000);
      document.querySelectorAll(".qtd, .valor").forEach(input => input.addEventListener("input", atualizarTotais));
      atualizarTotais();
    });
