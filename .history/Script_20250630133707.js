...
function mostrarVisualizacao() {
  ...
  const visualizacao = document.getElementById("visualizacaoOrcamento");
  
  // Clona o conteúdo como visualização (sem inputs)
  const clone = original.cloneNode(true);
  // Remove campos de input para exibir texto puro
  ...
  visualizacao.innerHTML = ""; // limpa antes
  visualizacao.appendChild(clone);
