...
function visualizarOrcamentoEmNovaPagina() {
  ...
  // Substitui todos os inputs e selects por texto simples
  ...
  if (field) {
    ...
    if (field.tagName === "SELECT") {
      ...
      span.textContent = field.value;
        ...
        // Substitui o input/select pelo span
    label.innerHTML = label.childNodes[0].textContent + " "; // mantém "A/C:" por exemplo
